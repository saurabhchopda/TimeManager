  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
      ...
      <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-4 sm:mb-6">
        ...
        <div className="mt-6 sm:mt-8 bg-yellow-50 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            <Brain className="text-yellow-600 w-5 h-5" />
            <h3 className="font-semibold text-gray-800 text-base">
              Anti-Procrastination Strategies
            </h3>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-2 text-sm text-gray-700">
            <div>
